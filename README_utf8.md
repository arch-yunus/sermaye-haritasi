...
Bu veri tabanı, küresel sermayenin sadece ulus devlet sınırlarıyla değil; tarihsel göç yolları, diaspora ağları, köklü kast/ticaret gelenekleri ve sosyo-kültürel yapılarla nasıl bir korelasyon içinde olduğunu haritalandırmak amacıyla kurulmuştur.
...
* **Etnik Sınıflandırma Stratejisi:** Bireylerin sadece mevcut vatandaşlıkları değil; biyolojik ebeveyn kökenleri, tarihsel diaspora aidiyetleri (Aşkenaz, Mizrahi vb.) ve alt etnik kırılımları (Gucerat, Tamil, Han vb.) baz alınmıştır.
...
Repo içeriğindeki veriler derinlemesine incelendiğinde, küresel sermayenin rastgele dağılmadığı, belirli **kültürel/tarihsel nişlerde** kümelendiği görülmektedir:

### 1. Aşkenaz Yahudisi Diasporası (Finans & Yazılım Ağları)
* **Yoğunluk:** Listenin yaklaşık %25'ini doğrudan veya melez olarak kapsamaktadır.
* **Karakteristik Semptom:** Wall Street'in büyük "Kaldıraçlı/Alternatif Finans" yapıları (Blackstone, Citadel, Susquehanna, Renaissance Tech) ve Silikon Vadisi'nin algoritmik temelleri (Google, Meta, Oracle) bu ekosistemin elinde konsolide olmuştur. Tarihsel olarak Avrupa'daki fiziki mülkiyet yasakları, bu topluluğu nesiller boyu "taşınabilir entelektüel sermayeye" (matematik, finans, hukuk) yönlendirmiştir.

### 2. Han Çinlileri (Üretim & Ölçek Mühendisliği)
* **Yoğunluk:** Listenin Asya bacağını domine etmektedir.
* **Karakteristik Semptom:** Batı sermayesinin aksine tamamen "fiziksel üretim, batarya, çip ve lojistik entegrasyon" (CATL, Foxconn, BYD, Midea) ile "agresif e-ticaret algoritmaları" (Temu, TikTok, Tencent) üzerine kuruludur. Çin iç savaşı ve mülteci geçmişleri, bu grupta inanılmaz derecede yüksek bir risk iştahı yaratmıştır.

### 3. Guceratlılar ve Parsiler (Hindistan'ın Lokomotifleri)
* **Yoğunluk:** Hindistan kökenli milyarderlerin %80'ini oluştururlar.
* **Karakteristik Semptom:** Hindistan nüfusunun çok küçük bir kısmını oluşturmalarına rağmen (özellikle Zerdüşt Pers göçmenleri olan Parsiler ve ticaret kastından gelen Guceratlılar) ülkenin çelik, ilaç, perakende ve teknoloji (Ambani, Adani, Shanghvi, Poonawalla) hatlarını tek elden yönetirler. Yüzyıllardır korunan kapalı ticaret loncası kültürüne sahiptirler.

### 4. Anglo-Sakson "Eski Para" (Old Money) Dayanıklılığı
* **Yoğunluk:** Amerika ve Avustralya'nın altyapı katmanında yer alırlar.
* **Karakteristik Semptom:** Genellikle perakende (Walmart), temel gıda (Mars), geleneksel enerji (Continental Resources) ve madencilik (Hancock, Fortescue) gibi "dünya yıkılsa bile işlemeye devam edecek" fiziksel tekelleri ellerinde tutarlar. Kuşaklararası vakıf ve aile meclisleri mimarisiyle serveti korurlar.

---

## 🛠️ Kurulum ve Katkıda Bulunma

Bu veri tabanı dinamik olarak güncellenmektedir. Sektörel kırılımları veya etnik köken korelasyonlarını analiz etmek için Python scriptleri geliştirebilirsiniz.

### Geliştirici Ortamı:
```bash
# Repoyu klonlayın
git clone [https://github.com/kullaniciadi/sermaye-haritasi.git](https://github.com/kullaniciadi/sermaye-haritasi.git)

# Proje dizinine girin
cd sermaye-haritasi

# Veri modellerini doğrulamak için analiz scriptini çalıştırın (örnektir)
python3 scripts/analyze_demographics.py

```

### Katkı Sağlama Protokolü:

Yeni bir milyarderin köken şifrelerini eklemek veya net varlık güncellemesi yapmak için lütfen tarihsel kaynakları (biyografiler, Forbes arşivleri, güvenilir soykütüğü dökümanları) ekte sunarak bir **Pull Request (PR)** açın.

---

```
"Para, her şeyin ölçüsü olmaktan çıktığında; sermaye, tarihin ve genetiğin haritasına dönüşür."
