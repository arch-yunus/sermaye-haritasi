...
![Sektör Dağılımı](outputs/sector_distribution.png)
![Sektörel Net Varlık](outputs/sector_net_worth.png)
![Kilit Etnik Tanımlayıcılar](outputs/ethnicity_keywords.png)
![En Sık Görülen Vatandaşlıklar](outputs/top_citizenships.png)
